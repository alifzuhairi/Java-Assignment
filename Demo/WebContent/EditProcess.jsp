...
<p>
	  ...
	  if (login){
		  try{
			  ...
			  PreparedStatement stmt = connection.prepareStatement("update students set name= ?,password=password(?), department=? where matric = ?");
			  ...
			  stmt.setString(4,request.getParameter("matric"));
